...
#Create a summary for the loss. Allow it to write to tensorboard
...
#Create a summary for accuracy. Allow it to write to tensorboard
tf.summary.scalar("accuracy", accuracy)

#Merge the summaries into a single plot
...
with tf.Session() as session:
    ...
    #Writing the summaries to tensorboard
